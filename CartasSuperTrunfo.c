...
int main(){
	...
	printf("O Estado da carta2 %s  - Codigo da cidade da carta2 %s  - Cidade da carta2 %s - Quantidade da polulacao da carta2  %d - Quantida da area Habitada da Carta2 %.2f KM - Valor do PIB Carta2 %.2f MILHOES - Quantidade de Ponto Turisco Carta2 %d ", estado2, codigo2, cidade2, populacao2, area2, pib2, pontoturistico2);
